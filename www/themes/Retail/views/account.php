<div id="body">
		...
		?></b></p><?php /* Buscar un mejor 'formato' para imprimir si está o no bloqueada la cuenta con 'true/false' y un mensaje cambiado de "Bloqueado: Bloqueado" a otro para evitar redundancias*/?>
		<p>Bloqueado: <b style="text-transform:capitalize;"><?php ($locked != 0) ? print "Bloqueado" : print "No Bloqueado"; ?></b></p>
